...
func GetHardwareData(w http.ResponseWriter, r *http.Request) {
       ...
       interfStat, err := net.Interfaces()
        ...
        html = html + "-------------------Memory Utilization-----------------------------------<br><br>"
        ...
        html = html + "-----------------------------Hardware details-------------------------<br><br>"
...
func SayName(w http.ResponseWriter, r *http.Request) {
        w.Write([]byte("Hello, I'm a machine and my name is kiran"))
}
...
func main() {
        ...
        mux.HandleFunc("/gethw1data", GetHardwareData)
